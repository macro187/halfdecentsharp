...
/// match its <tt>.Equals()</tt> or <tt>.Compare()</tt>.
///
...
/// correct <tt>.GetHashCode()</tt>, or implement <tt>IComparable<T></tt> from
/// this namespace, which includes a <tt>.GetHashCode()</tt>.
// =============================================================================

public struct
SystemComparableComparer<
    T
>
    : IComparer< T >
