...
)
{
    ...
    LT<T> gt = (LT<T>)( that.GetUnderlying() );
    return
...
private static Com.Halfdecent.Globalisation.Localised< string > _S( string s, params object[] args ) { return Com.Halfdecent.Resources.Resource._S( typeof( LT<> ), s, args ); }
