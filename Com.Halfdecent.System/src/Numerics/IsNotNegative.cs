...
/// Predicate: "(Real) is not negative"
///
public class
IsNotNegative
    : PredicateBase< Real >
...
GetTermRequirements()
{
    yield return new IsPresent< Real >();
}
...
)
{
    ...
    return Resource._S( "{0} is not negative", termIdentifier );
}
...
{
    new IsPresent< Localized< string > >().ReallyRequire( termIdentifier );
    return Resource._S( "{0} is negative", termIdentifier );
}
...
{
    new IsPresent< Localized< string > >().ReallyRequire( termIdentifier );
    return Resource._S( "{0} must not be negative", termIdentifier );
}
