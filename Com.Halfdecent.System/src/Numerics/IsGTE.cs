...
/// Initialise a new <tt>IsGTE< T ></tt> that compares against the given
/// value
///
public
IsGTE(
...
)
{
    ...
    return _S( "{0} is greater than or equal to {1}",
        termIdentifier,
...
{
    new IsPresent< Localized< string > >().ReallyRequire( termIdentifier );
    return _S( "{0} must be greater than or equal to {1}",
        termIdentifier,
        this.ComparisonValue );
}
