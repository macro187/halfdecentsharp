...
/// Initialise a new <tt>IsLTE</tt> that compares against the given
/// value
///
public
IsLTE(
...
)
{
    ...
    return Resource._S( "{0} is less than or equal to {1}",
        termIdentifier,
...
{
    new IsPresent< Localized< string > >().ReallyRequire( termIdentifier );
    return Resource._S( "{0} must be less than or equal to {1}",
        termIdentifier,
        this.ComparisonValue );
}
