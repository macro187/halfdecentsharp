...
/// An adapter that makes an <tt>IList< T ></tt> supporting read, addition, and
/// removal operations out of a <tt>System.Collections.Generic.IList< T ></tt>
///
public class
IListFromResizableIListAdapter<
    T
>
...
/// Initialize a new <tt>IListFromResizableIListAdapter< T ></tt> adapting
...
IListFromResizableIListAdapter(
    SCG.IList< T > list ///< The list to adapt
                        ...
                        ///  - Supports addition and removal of items
)
    : base( list )
{
}
