...
/// Initialize a new <tt>IBagFromReadOnlyICollectionAdapter< T ></tt> adapting
...
Stream()
{
    return SCGInteropAlgorithms.IBagStreamViaIEnumerable( this.Collection );
}
