...
/// Create a new <tt>HDInvalidOperationException</tt> with a given message
///
public
HDInvalidOperationException(
...
{
    this.message = message ?? _S("Operation is not valid due to the current state of the object");
}
...
/// Override of <tt>Exception.Message</tt> via shim
protected override
string
BaseMessage
{
