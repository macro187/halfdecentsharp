...
// =============================================================================
/// A <tt>System.ArgumentOutOfRangeException</tt> having to do with a particular value
// =============================================================================

public class
ArgumentOutOfRangeValueException
        ...
        innerException )
{
    ...
    this.messageformat =
        messageFormat ?? _S("Unable to proceed because {0} is out of range");
}
