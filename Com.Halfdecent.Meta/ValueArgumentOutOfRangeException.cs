...
ValueArgumentOutOfRangeException(
    ...
    : this( parameter, messageFormat, null, null )
{
}
...
ValueArgumentOutOfRangeException(
    ...
    : this( parameter, messageFormat, actualValue, null )
{
}
        ...
        innerException )
{
    ...
    this.MessageFormat = messageFormat ?? _S("{0} is out of range");
}
...
private static Com.Halfdecent.Globalisation.Localised< string > _S( string s, params object[] args ) { return Com.Halfdecent.Resources.Resource._S( typeof( ValueArgumentOutOfRangeException ), s, args ); }
